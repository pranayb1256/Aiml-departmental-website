...
const Results = () => {
    ...
    const handleImageUpload = async ({ file }) => {
        ...
        formData.append("topperImage", file); // Make sure the key matches backend
        ...
        try {
            ...
            setNewResult((prev) => ({
                ...prev,
                topperImage: response.data.secure_url,
            }));
        } catch (error) {
    ...
    return (
        <div className="p-6 bg-white shadow-lg rounded-lg">
            ...
            <Modal title="Add New Result" visible={isModalOpen} onOk={handleAddResult} onCancel={() => setIsModalOpen(false)}>
                ...
                <Input type="number" placeholder="Topper Cgpa" value={newResult.topperCgpa} onChange={(e) => setNewResult({ ...newResult, topperCgpa: e.target.value })} className="mb-2" />
