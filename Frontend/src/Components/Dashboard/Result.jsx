...
const Results = () => {
  ...
  const handleAddResult = async () => {
    ...
    try {
      const apiUrl = import.meta.env.VITE_API_URL;
      await axios.post(`${apiUrl}/result`, newResult);
  ...
  const handleDelete = async (id) => {
    try {
      ...
      await axios.delete(`${apiUrl}/result/${id}`);
    ...
    <div className="p-6 bg-white shadow-lg rounded-lg">
      ...
      >
        <Input
          ...
          value={newResult.topperName}
          onChange={(e) =>
            setNewResult({ ...newResult, topperName: e.target.value })
          }
          className="mb-2"
        />
        <Input
          type="number"
          placeholder="Topper CGPA"
          value={newResult.topperCgpa}
          onChange={(e) =>
            setNewResult({ ...newResult, topperCgpa: Number(e.target.value) })
          }
          className="mb-2"
        />
        ...
        <Select
          ...
          onChange={(value) => setNewResult({ ...newResult, year: value })}
        ...
        <Input
          ...
          onChange={(e) =>
            setNewResult({ ...newResult, semester: Number(e.target.value) })
          }
          className="mb-2"
        />
        <Input
          ...
          value={newResult.passPercentage}
          onChange={(e) =>
            setNewResult({
              ...newResult,
        ...
        <Input
          type="number"
          placeholder="Avg CGPA"
          value={newResult.avgCgpa}
          onChange={(e) =>
            setNewResult({ ...newResult, avgCgpa: Number(e.target.value) })
          }
          className="mb-2"
        />
        <Input
        ...
        <Input
          type="number"
          placeholder="Passed Students"
          value={newResult.passedStudents}
          onChange={(e) =>
            setNewResult({
              ...newResult,
              passedStudents: Number(e.target.value),
            })
          }
          className="mb-2"
        />
        <Input
          type="number"
          placeholder="Failed Students"
          value={newResult.failedStudents}
          onChange={(e) =>
            setNewResult({
              ...newResult,
              failedStudents: Number(e.target.value),
            })
          }
          className="mb-2"
        />
