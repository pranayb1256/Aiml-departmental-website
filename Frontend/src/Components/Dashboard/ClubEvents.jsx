...
const ClubEvents = () => {
  ...
  const handleDateTimeChange = (dateTime) => {
    setNewEvent((prev) => ({
      ...prev,
      dateTime: dayjs(dateTime).tz("Asia/Kolkata").toISOString(),
    }));
  };
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <DateTimePicker
              ...
              value={
                newEvent.dateTime
                  ? dayjs(newEvent.dateTime).tz("Asia/Kolkata")
                  : null
              }
            ...
            <Grid item xs={12} sm={6} md={4} key={event._id}>
              ...
              >
                ...
                <CardContent>
                  ...
                  <Typography>
                    Date & Time: {convertToIST(event.dateTime)}
                  </Typography>
                  <Typography>Venue: {event.venue}</Typography>
                  <Typography>
                    Description: {event.description.slice(0, 50)}...
                  </Typography>
                  <Typography>event: {event.eventType}...</Typography>
