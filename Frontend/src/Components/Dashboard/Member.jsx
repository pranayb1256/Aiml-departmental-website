...
const Member = () => {
  ...
  const [selectedClub, setSelectedClub] = useState("AIMSA"); // Default to AIMSA
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {/* Member Form */}
      <form onSubmit={addMember} className="bg-white p-6 rounded-lg shadow-md mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <input type="text" name="name" placeholder="Name" onChange={handleChange} required className="border p-2 rounded w-full" />
          <input type="text" name="yearBranch" placeholder="Year & Branch" onChange={handleChange} required className="border p-2 rounded w-full" />
          <input type="text" name="position" placeholder="Position" onChange={handleChange} required className="border p-2 rounded w-full" />
          <input type="text" name="photo" placeholder="Photo URL" onChange={handleChange} required className="border p-2 rounded w-full" />
          <input type="text" name="linkedin" placeholder="LinkedIn URL" onChange={handleChange} className="border p-2 rounded w-full" />
          <input type="text" name="instagram" placeholder="Instagram URL" onChange={handleChange} className="border p-2 rounded w-full" />
          <input type="text" name="github" placeholder="GitHub URL" onChange={handleChange} className="border p-2 rounded w-full" />
        </div>
        <button type="submit" className="mt-4 bg-blue-600 text-white px-4 py-2 rounded w-full hover:bg-blue-700 transition">Add Member</button>
      </form>
