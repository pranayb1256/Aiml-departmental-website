...
const TimetableManager = () => {
    ...
    const handleUpload = async (file) => {
        ...
        try {
            setLoading(true);
            // Send the form data to the backend, which will upload the file to Cloudinary
            ...
            if (response.status === 200) {
                // If upload was successful, refresh the timetable and display success message
                fetchTimetable();
                fetchAllTimetables(); // Refresh the list of timetables
